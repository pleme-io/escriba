  ...
  internal = rec {
    ...
    crates = {
      ...
      "escriba" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./escriba; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "escriba-lsp-client" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-multi-thread" "io-std" "io-util" "sync" "fs" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
      ...
      "escriba-mcp" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./escriba-mcp; };
        libName = "escriba_mcp";
        authors = [
          "pleme-io"
        ];
      ...
      "escriba-spec" = rec {
        ...
        crateBin = [
          {
            name = "escriba-spec-dump";
            path = "src/bin/dump.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./escriba-spec; };
        libName = "escriba_spec";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "madori" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        sha256 = "0wqnmnk48lbw93cs4vfmn0jhqzapkiw0ivxlc8116g03xww3bqsr";
        dependencies = [
          {
            name = "egaku";
            packageId = "egaku";
      ...
      "quick-xml" = rec {
        ...
        version = "0.39.3";
        edition = "2021";
        sha256 = "02w71hyn6z4by58zzxaada39910ay93hbzjgkgg5qr8jqdqaj7bj";
        libName = "quick_xml";
        dependencies = [
          {
            name = "memchr";
      ...
      "rustix 0.38.44" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "event" "fs" "libc-extra-traits" "pipe" "process" "shm" "std" "stdio" "system" "termios" "thread" "use-libc-auxv" ];
      };
      "rustix 1.1.4" = rec {
        crateName = "rustix";
        version = "1.1.4";
      ...
      "tatara-lisp" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "f8fe0e0d8b785a324d4c545b126f3242f82abf37";
          sha256 = "0rwcsh8igmynxwf9ix2jgabpfl325s51qjrlasrg138m04mwd79f";
        };
        libName = "tatara_lisp";
        authors = [
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "fs" "io-std" "io-util" "macros" "rt" "rt-multi-thread" "sync" "tokio-macros" ];
      };
      "tokio-macros" = rec {
      ...
      "tree-sitter" = rec {
        ...
        edition = "2021";
        links = "tree-sitter";
        sha256 = "1jkda5n43m7cxmx2h7l20zxc74nf9v1wpm66gvgxrm5drscw8z6z";
      ...
      "tree-sitter-highlight" = rec {
        ...
        version = "0.22.6";
        edition = "2021";
        sha256 = "01qrn9cqk4wkgwl7qj0pcddfdbqvps6k0qwfm9mfqvm99zihzjpa";
      ...
      "tree-sitter-rust" = rec {
        ...
        version = "0.21.2";
        edition = "2021";
        sha256 = "14qwvrn248k8lrbvlz04wr7nrr5c72h3skwqx8fp945z43s90xi7";
